...
import Evergreen.V71.L0
import Evergreen.V71.Parser.Block
import Evergreen.V71.Render.DifferentialParser
...
type alias FrontendModel =
    ...
    , sourceText : String
    , ast : Evergreen.V71.L0.SyntaxTree
    , editRecord : Evergreen.V71.Render.DifferentialParser.EditRecord (Tree.Tree Evergreen.V71.Parser.Block.IntermediateBlock) (Tree.Tree Evergreen.V71.Parser.Block.ExpressionBlock)
    , tableOfContents : List Evergreen.V71.Parser.Block.ExpressionBlock
    , title : List Evergreen.V71.Parser.Block.ExpressionBlock
    , searchCount : Int
...
type FrontendMsg
    ...
    | Render Evergreen.V71.Render.Msg.L0Msg
    | ExportToMarkdown
    | ExportToLaTeX
    | Export
    | PrintToPDF
...
type ToBackend
    ...
    | DeleteDocumentBE Evergreen.V71.Document.Document
